...
void update()
{
	...
	// line_draw_bresenham(8,8,0,0);
	// line_draw_bresenham(0,0,8,8);
		
	// line_draw_bresenham(0,0,0,8);
	// line_draw_bresenham(8,8,8,0);
	
	// line_draw_bresenham(0,0,8,0);
	// line_draw_bresenham(8,8,0,8);
